...
# Main VPC with DNS hostname support enabled
...
# Public subnet in availability zone A (e.g., ap-southeast-1a)
...
# Public subnet in availability zone B (e.g., ap-southeast-1b)
...
# Public route table directing all traffic to the Internet Gateway
